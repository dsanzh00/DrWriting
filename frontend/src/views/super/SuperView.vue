        ...
        <div class="col">
            <table class="table table-bordered table-hover">
              ...
              <thead>
                <th >
                  <td>
                    <button class="btn btn-secondary" onclick="location.href='http://localhost:8080/newUser'">
            ...
            <table class="table table-bordered table-hover">
                ...
                <tbody class="table-group-divider" id="Contenido">
                    <tr v-for="user in usuarios" :key="user.id">
                        ...
                        <td>
                            <button class="btn btn-danger" v-on:click="eliminarUser(user.id)">
                                <span class="material-icons-two-tone">
                                    delete
                                    </span>
                            </button>
                            &nbsp;
                            <button class="btn btn-info" v-on:click="editarUser(user.id)">
                                <span class="material-icons-two-tone">
                                    edit
                                    </span>
                            </button>
...
export default {
  ...
  methods: {
    ...
    getUsuarios() {
      // Realizar la solicitud GET al servidor backend para obtener los datos de la base de datos
      axios
        .get("http://localhost:3000/usuarios/nosuper")
        .then((usuarios) => {
          usuarios.data.forEach(function (i) {
            if (i.type === "worker") {
