                ...
                <tbody class="table-group-divider" id="Contenido">
                    <tr v-for="lab, i in labels" :key="lab.id">
                        ...
                        <td>
                            ...
                            <button class="btn btn-info" v-on:click="editLab(lab.id)">
                                <span class="material-icons-two-tone">
                                    edit
                                    </span>
                            </button>  
...
export default {
  ...
  methods: {
      ...
      axios
        ...
        .then((result) => {
          ...
          if (result.status === 200) {
            axios
              .get("https://app.konfuzio.com/api/v3/labels/", {
                params: {
                  limit: "80",
                },
                headers: {
    ...
    eliminarLab(id) {
      axios
        .delete("https://app.konfuzio.com/api/v3/labels/" + id + "/", {
          headers: {
            accept: "*/*",
            Authorization:
              "Basic ZHNhbnpoMDBAZXN0dWRpYW50ZXMudW5pbGVvbi5lczp0ZmcxMjM0NQ==",
