            ...
            <table class="table table-bordered table-hover">
                <thead>
                    <th >
                        ...
                        <td>
                            <button class="btn btn-secondary" onclick="location.href='http://localhost:8080/newCategory'">
                                <span class="material-icons-two-tone">
                                    add
                                    </span>
                            </button>
            ...
            <table class="table table-bordered table-hover">
                ...
                <tbody class="table-group-divider" id="Contenido">
                    <tr v-for="cat, i in categories" :key="cat.id">
                        ...
                        <td>
                            <button class="btn btn-danger" v-on:click="eliminarCat(cat.id)">
                                <span class="material-icons-two-tone">
                                    delete
                                    </span>
                            </button>
                            <button class="btn btn-info" v-on:click="editCat(cat.id)">
                                <span class="material-icons-two-tone">
                                    edit
                                    </span>
                            </button>  
