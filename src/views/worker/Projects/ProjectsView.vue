            ...
            <table class="table table-bordered table-hover">
                ...
                <tbody class="table-group-divider" id="Contenido">
                    <tr v-for="proj, i in projects" :key="proj.id">
                        ...
                        <td>
                            <button class="btn btn-danger" v-on:click="eliminarProj(proj.id)">
                                <span class="material-icons-two-tone">
                                    delete
                                    </span>
                            </button>
                            <button class="btn btn-info" v-on:click="editProj(proj.id)">
                                <span class="material-icons-two-tone">
                                    edit
                                    </span>
                            </button>  
...
export default {
  ...
  methods: {
      ...
      axios
        ...
        .then((result) => {
          ...
          if (result.status === 200) {
            axios
              .get("https://app.konfuzio.com/api/v3/projects/", {
                params: {
                  limit: "80",
                },
                headers: {
    ...
    eliminarProj(id) {
      axios
        .delete("https://app.konfuzio.com/api/v3/projects/" + id + "/", {
          headers: {
            accept: "*/*",
            Authorization:
              "Basic ZHNhbnpoMDBAZXN0dWRpYW50ZXMudW5pbGVvbi5lczp0ZmcxMjM0NQ==",
